...
aws emr create-cluster --name "SparkStep-RunKinesis" \
    ...
    --steps Type=Spark,Name="Spark-Job-RunKinesis",ActionOnFailure=CONTINUE,Args=[--deploy-mode,client,--master,yarn,--num-executors,2,--executor-cores,2,--jars,s3://pyspark-sunil/lib/spark-streaming-kinesis-asl-assembly_2.12-3.0.0.jar,s3://pyspark-sunil/run/pyspark-kinesis.py,--p,/tmp/pyspark-kinesis.properties] \
    --use-default-roles \
    --auto-terminate
