...
$SPARK_HOME/bin/spark-submit --master local[4] \
    --jars "$APP_HOME_DIR/lib/spark-streaming-kinesis-asl-assembly_2.12-3.0.0.jar" \
    pyspark-stream-files.py --p $APP_HOME_DIR/scripts/pyspark-stream-files.properties
